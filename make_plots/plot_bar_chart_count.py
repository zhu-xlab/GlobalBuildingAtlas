...
# Output path
out_path = '/home/fahong/Datasets/ai4eo3/Global3D/statistics/figures/bar_number.png'
...
data = {key: sum(info_dict[key].values()) for key in continents}
...
# Title and ticks
plt.title("# of Buildings by Continent", fontsize=22)
...
bottom_val = max(1e-2, min_val * 0.5)
top_val = max_val * 1.9  # increased from 1.3 to 1.5 for more headroom
...
for bar, value in zip(bars, sorted_values):
    ...
    if candidate_y < top_val * 0.95:
        ...
        # If the bar is so tall that even clamping is near the top,
        # optionally place text inside (up to you).
        va = 'top'
        text_color = 'white'
...
plt.tight_layout()
# Increase top margin so title/labels have more space
