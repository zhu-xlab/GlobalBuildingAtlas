...
class DeepQNetV9(BaseModule):
    ...
    def cal_loss_gt_state(self, games):
        ...
        B, N, _ = points.shape
        gt_point_seqs, batch_actions = self.gen_gt_point_seqs(gt_poly_idxes_list, batch_idxes,
                                                        batch_sizes, device=points[0].device)
        ...
        pos_mask = gt_scores > 0.5
        loss_gt_state = self.loss_fun(scores, gt_scores)
