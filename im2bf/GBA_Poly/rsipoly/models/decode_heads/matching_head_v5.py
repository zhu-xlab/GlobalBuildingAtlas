...
class OptimalMatchingV5(BaseModule):

    def __init__(self, descriptor_dim=64, remove_last=False, return_polygons=False, mask_graph=True,
                 block_comp_mask=False):
        super(OptimalMatchingV5, self).__init__()
    ...
    def forward_train(self, img, point_feats, graph_targets, point_preds, comp_mask=None, probs=None):
        if self.remove_last:
