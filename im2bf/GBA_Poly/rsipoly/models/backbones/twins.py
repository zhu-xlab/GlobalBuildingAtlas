...
from rsipoly.models.backbones.mit import EfficientMultiheadAttention
from rsipoly.models.builder import BACKBONES
...
class GlobalSubsampledAttention(EfficientMultiheadAttention):
    ...
    which is a module from rsipoly.models.backbones.mit.py.
