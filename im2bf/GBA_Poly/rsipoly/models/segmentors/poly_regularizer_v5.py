...
class PolyRegularizerV5(EncoderDecoder):
    ...
    def __init__(
        ...
        super(PolyRegularizerV5, self).__init__(backbone, decode_head, **kwargs)
    ...
    def slide_inference(self, img, img_meta, rescale=None, **kwargs):
        ...
        for i in range(batch_size):
            ...
            for j in tqdm(range(len(splits) - 1), desc=f'Regularizing on {file_str}/{box_str}'):
