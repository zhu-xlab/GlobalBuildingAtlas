...
class PolyDQNEncoderDecoderV14(EncoderDecoder):
    ...
    def __init__(self, backbone, decode_head, assigner, sampler, dqn_head, point_head, wandb_cfg=None,
        ...
        super(PolyDQNEncoderDecoderV14, self).__init__(backbone, decode_head, **kwargs)
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        if dqn_states == {}:
            ...
            games = self.dqn_head.sample_games(add_dummy=False)
