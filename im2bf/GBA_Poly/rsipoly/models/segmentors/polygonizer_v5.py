...
class PolygonizerV5(BaseModule):
    ...
    def __init__(
        ...
        super(PolygonizerV5, self).__init__(init_cfg)
    ...
    def slide_inference(self, img, img_meta, rescale, **kwargs):
        ...
        pred_polygons = self.simp_net.slide_inference([pred_mask], img_meta, rescale=rescale)
        shape_polygons = [shapely.Polygon(shell=polygon[0], holes=polygon[1:]) for polygon in pred_polygons]
