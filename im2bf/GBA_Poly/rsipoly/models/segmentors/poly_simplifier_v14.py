...
class PolySimplifierV14(BaseModule):
    ...
    def __init__(
        ...
        super(PolySimplifierV14, self).__init__()
    ...
    def forward_train(self, img, seg_logits, gt_semantic_seg, gt_features, **kwargs):
        ...
        batch_matched_rings = self.get_matched_rings(pred_polygons, gt_features, min_precision=matched_precision)
