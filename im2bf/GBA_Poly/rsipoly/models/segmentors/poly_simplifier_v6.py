...
class PolySimplifierV6(EncoderDecoder):
    ...
    def __init__(
        ...
        super(PolySimplifierV6, self).__init__(backbone, decode_head, **kwargs)
    ...
    def sample_rings(self, batch_polygons, batch_gt_polygons, ring_len=20, num_bins=32):
        batch_rings = []
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg, contours, contour_labels, gdal_features, gt_features, **kwargs):
        ...
        ring_angle_targets = torch.cat(ring_angle_targets, dim=0).to(img.device).argmax(dim=-1)
