...
class PolySimplifierV8(EncoderDecoder):
    ...
    def __init__(
        ...
        super(PolySimplifierV8, self).__init__(backbone, decode_head, **kwargs)
    ...
    def slide_inference(self, img, img_meta, rescale=None, contours=None, contour_labels=None,
        ...
        ring_pred_next = []
        # ring_pred_angle = []
        print('Simplifying the polygons...')
        ...
        # ring_pred_angle = torch.cat(ring_pred_angle, dim=0).squeeze(-1)
        ...
        for i in tqdm(range(len(all_ring_sizes))):
            cur_pred_polygon = []
            for j in range(len(all_ring_sizes[i])):
                ...
                # cur_pred_angle = torch.zeros(cur_ring_len)
