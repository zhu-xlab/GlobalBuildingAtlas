...
class PolyDQNEncoderDecoderV4(EncoderDecoder):
    ...
    def __init__(self, backbone, decode_head, assigner, sampler, dqn_head, point_head, wandb_cfg=None,
        ...
        super(PolyDQNEncoderDecoderV4, self).__init__(backbone, decode_head, **kwargs)
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        if not self.freeze_base_net:
            ...
            # if game_level > 0:
            #     self.dqn_head.init_state(game_level)

            if init_success:
                success_vector = None
                for i in range(game_level * 5):
