...
class PolySimplifierV3(EncoderDecoder):
    ...
    def __init__(
        ...
        dice_loss_conf=None, disc_step=5, **kwargs,
    ):
        super(PolySimplifierV3, self).__init__(backbone, decode_head, **kwargs)
    ...
    def cal_gan_loss(self, img, logits, is_disc=False):
        ...
        fake_img = up_logits[:, 1:, offset[1]:offset[1]+patch_size, offset[0]:offset[0]+patch_size]
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        if self.cur_iter % self.disc_step == 1:
            ...
            loss_gan = self.cal_gan_loss(img, seg_logits, is_disc=True)
            ...
            losses, states = self(**data_batch)
            seg_logits = states['seg_logits']
            loss_gan = self.cal_gan_loss(img, seg_logits, is_disc=False)
            losses.update(loss_gan)
