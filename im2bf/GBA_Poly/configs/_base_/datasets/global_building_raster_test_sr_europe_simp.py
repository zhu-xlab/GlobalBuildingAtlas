...
# in_base_dir = 'AFRICA/glcv103_guf_wsf' # this prefix will be copied to the out_dir
# out_root = '/home/Datasets/ai4eo/Dataset4EO/GlobalBF/polygon_outputs'

in_root = '/home/fahong/Datasets/ai4eo/Dataset4EO/GlobalBFV2/merged_masks/'
in_base_dir = './' # this prefix will be copied to the out_dir
out_root = '/home/fahong/Datasets/ai4eo/Dataset4EO/GlobalBFV2/polygons'
...
test_pipeline = [
    dict(type='LoadRasterWithWindow', repeat=True),
