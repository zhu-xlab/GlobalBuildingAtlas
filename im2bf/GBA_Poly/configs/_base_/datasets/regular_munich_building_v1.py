...
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53, 128.], std=[58.395, 57.12, 57.375, 128.], to_rgb=True
)
crop_size = (512, 512)
train_pipeline = [
    dict(type='LoadImageFromFile', use_mask_as_img=False, combine_mask_with_img=True,
         binarize_mask=True),
    # dict(type='LoadAnnotations', reduce_zero_label=True),
    # dict(type='LoadPolyAnn'),
    # dict(type='Resize', img_scale=(1024, 1024), ratio_range=(0.6, 1.4)),
    dict(type='Resize', img_scale=(2048, 2048), ratio_range=(0.6, 1.4)),
